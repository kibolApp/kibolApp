...
use Tests\TestCase;
use Database\Seeders\SlaskWroclawSeeder as Seeder;
...
class slaskwroclawSeederTest extends TestCase
{
    ...
    public function testItSeedsslaskwroclawTableWithExpectedData()
    {
        $this->seed(Seeder::class);

        $this->assertDatabaseCount('slaskwroclaw', count($this->getExpectedData()));
        $this->assertDatabaseHas('slaskwroclaw', $this->getExpectedData()[0]);
    }
    ...
    {
        return ["Lechia Gdańsk", "Motor Lublin", "Miedź Legnica"];
    }
