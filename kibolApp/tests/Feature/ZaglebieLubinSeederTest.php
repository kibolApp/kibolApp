...
use Tests\TestCase;
use Database\Seeders\ZaglebieLubinSeeder as Seeder;
...
class ZaglebieLubinSeederTest extends TestCase
{
    ...
    public function testItSeedsZaglebieLubinTableWithExpectedData()
    {
        $this->seed(Seeder::class);

        $this->assertDatabaseCount('ZaglebieLubin', count($this->getExpectedData()));
        $this->assertDatabaseHas('ZaglebieLubin', $this->getExpectedData()[0]);
    }
    ...
    {
        return ["Arka Gdynia", "Odra Opole", "Zawisza Bydgoszcz"];
    }
